...
while play_again and game_on():
    ...
    # Calculating hands Valie
    player1.total_value()
    dealer.total_value()

    print(f'{player1.name} has {player1.player_hand[0].rank} of {player1.player_hand[0].suit} and {player1.player_hand[1].rank} of {player1.player_hand[1].suit} and the total value is {player1.player_hand_value}')
    print(f'Dealer has {dealer.dealer_hand[0].rank} of {dealer.dealer_hand[0].suit} and {dealer.dealer_hand[1].rank} of {dealer.dealer_hand[1].suit} and the total value is {dealer.dealer_hand_value}')
    ...
    while hit_player():
        player1.player_hand.append(dealer.deal_one())
        player1.total_value()
        print(f'New card for player 1 : {player1.player_hand[-1].rank} of {player1.player_hand[-1].suit}.\nNew hand value is: {player1.player_hand_value}')
        ...
        # PLayer 1 Blackjack
        elif player1.player_hand_value == 21:
